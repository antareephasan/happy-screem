...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TYPE "public"."enum_posts_blocks_cta_buttons_variant" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum_posts_blocks_cta_layout" AS ENUM('split', 'centered');
  CREATE TYPE "public"."enum_posts_blocks_cta_cta_type" AS ENUM('form', 'buttons');
  CREATE TYPE "public"."enum_posts_blocks_cta_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  ...
  CREATE TYPE "public"."enum_posts_blocks_faq_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_team_members_social_links_platform" AS ENUM('linkedin', 'twitter', 'dribbble');
  CREATE TYPE "public"."enum_posts_blocks_team_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_testimonials_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_pricing_table_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_two_column_layout_buttons_variant" AS ENUM('primary', 'secondary', 'link');
  CREATE TYPE "public"."enum_posts_blocks_two_column_layout_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum_posts_blocks_two_column_layout_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_feature_grid_bottom_buttons_variant" AS ENUM('primary', 'secondary', 'link');
  CREATE TYPE "public"."enum_posts_blocks_feature_grid_columns" AS ENUM('2', '3', '4');
  CREATE TYPE "public"."enum_posts_blocks_feature_grid_item_type" AS ENUM('icon', 'image');
  CREATE TYPE "public"."enum_posts_blocks_feature_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_header_buttons_variant" AS ENUM('primary', 'secondary', 'secondary-alt');
  CREATE TYPE "public"."enum_posts_blocks_header_layout" AS ENUM('split', 'fullscreen', 'simple');
  CREATE TYPE "public"."enum_posts_blocks_header_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum_posts_blocks_header_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_gallery_columns" AS ENUM('2', '3', '4');
  CREATE TYPE "public"."enum_posts_blocks_gallery_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_contact_info_methods_icon" AS ENUM('email', 'phone', 'location');
  CREATE TYPE "public"."enum_posts_blocks_contact_info_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_blog_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  CREATE TYPE "public"."enum_posts_blocks_dynamic_blog_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_blocks_cta_buttons_variant" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum__posts_v_blocks_cta_layout" AS ENUM('split', 'centered');
  CREATE TYPE "public"."enum__posts_v_blocks_cta_cta_type" AS ENUM('form', 'buttons');
  CREATE TYPE "public"."enum__posts_v_blocks_cta_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  ...
  CREATE TYPE "public"."enum__posts_v_blocks_faq_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_team_members_social_links_platform" AS ENUM('linkedin', 'twitter', 'dribbble');
  CREATE TYPE "public"."enum__posts_v_blocks_team_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_testimonials_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_pricing_table_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_two_column_layout_buttons_variant" AS ENUM('primary', 'secondary', 'link');
  CREATE TYPE "public"."enum__posts_v_blocks_two_column_layout_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum__posts_v_blocks_two_column_layout_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_feature_grid_bottom_buttons_variant" AS ENUM('primary', 'secondary', 'link');
  CREATE TYPE "public"."enum__posts_v_blocks_feature_grid_columns" AS ENUM('2', '3', '4');
  CREATE TYPE "public"."enum__posts_v_blocks_feature_grid_item_type" AS ENUM('icon', 'image');
  CREATE TYPE "public"."enum__posts_v_blocks_feature_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_header_buttons_variant" AS ENUM('primary', 'secondary', 'secondary-alt');
  CREATE TYPE "public"."enum__posts_v_blocks_header_layout" AS ENUM('split', 'fullscreen', 'simple');
  CREATE TYPE "public"."enum__posts_v_blocks_header_image_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum__posts_v_blocks_header_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_gallery_columns" AS ENUM('2', '3', '4');
  CREATE TYPE "public"."enum__posts_v_blocks_gallery_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_contact_info_methods_icon" AS ENUM('email', 'phone', 'location');
  CREATE TYPE "public"."enum__posts_v_blocks_contact_info_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_blog_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  CREATE TYPE "public"."enum__posts_v_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  CREATE TYPE "public"."enum__posts_v_blocks_dynamic_blog_grid_color_scheme" AS ENUM('light', 'dark', 'primary', 'secondary', 'custom');
  ...
  CREATE TYPE "public"."enum_courses_blocks_archive_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum_courses_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TYPE "public"."enum__courses_v_blocks_archive_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum__courses_v_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TYPE "public"."enum_blog_overview_blocks_archive_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum_blog_overview_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TYPE "public"."enum_course_overview_blocks_archive_relation_to" AS ENUM('posts');
  ...
  CREATE TYPE "public"."enum_course_overview_blocks_dynamic_blog_grid_post_source" AS ENUM('latest', 'featured', 'category');
  ...
  CREATE TABLE "pages_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_pages_blocks_cta_buttons_variant" DEFAULT 'default'
  );
  ...
  CREATE TABLE "pages_blocks_cta" (
  	...
  	"form_settings_terms_text" varchar DEFAULT 'By clicking Sign Up you''re confirming that you agree with our Terms and Conditions.',
  ...
  CREATE TABLE "pages_blocks_faq" (
  	...
  	"contact_section_contact_description" jsonb,
  ...
  CREATE TABLE "pages_blocks_team" (
  	...
  	"hiring_section_hiring_description" jsonb,
  ...
  CREATE TABLE "pages_blocks_feature_grid" (
  	...
  	"header_section_description" jsonb,
  ...
  CREATE TABLE "pages_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"post_source" "enum_pages_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  ...
  CREATE TABLE "_pages_v_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__pages_v_blocks_cta_buttons_variant" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"post_source" "enum__pages_v_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  ...
  CREATE TABLE "posts_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_posts_blocks_cta_buttons_variant" DEFAULT 'default'
  );
  ...
  CREATE TABLE "posts_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_posts_blocks_cta_layout" DEFAULT 'split',
  	"show_tagline" boolean DEFAULT false,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	"cta_type" "enum_posts_blocks_cta_cta_type" DEFAULT 'form',
  	"form_settings_form_placeholder" varchar DEFAULT 'Voer je e-mail in',
  	"form_settings_form_button_text" varchar DEFAULT 'Inschrijven',
  	"form_settings_terms_text" varchar DEFAULT 'By clicking Sign Up you''re confirming that you agree with our Terms and Conditions.',
  	"form_settings_terms_link" varchar DEFAULT '/terms',
  	...
  	"image_id" integer,
  	"image_alt" varchar,
  	"color_scheme" "enum_posts_blocks_cta_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "posts_blocks_faq_faqs" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"question" varchar,
  ...
  CREATE TABLE "posts_blocks_faq" (
  	...
  	"contact_section_contact_button_text" varchar DEFAULT 'Contact',
  	"contact_section_contact_button_link" varchar DEFAULT '/contact',
  	"color_scheme" "enum_posts_blocks_faq_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "posts_blocks_team" (
  	...
  	"hiring_section_hiring_button_text" varchar DEFAULT 'Open posities',
  	"hiring_section_hiring_button_link" varchar DEFAULT '/careers',
  	"color_scheme" "enum_posts_blocks_team_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_testimonials_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"rating" numeric DEFAULT 5,
  ...
  CREATE TABLE "posts_blocks_testimonials" (
  	...
  	"description" jsonb,
  	"show_stars" boolean DEFAULT true,
  	"color_scheme" "enum_posts_blocks_testimonials_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_pricing_table_plans_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"feature" varchar
  ...
  CREATE TABLE "posts_blocks_pricing_table_plans" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "posts_blocks_pricing_table" (
  	...
  	"description" jsonb,
  	"show_billing_toggle" boolean DEFAULT true,
  	"color_scheme" "enum_posts_blocks_pricing_table_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_two_column_layout_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_posts_blocks_two_column_layout_buttons_variant" DEFAULT 'secondary'
  );
  
  CREATE TABLE "posts_blocks_two_column_layout" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_position" "enum_posts_blocks_two_column_layout_image_position" DEFAULT 'right',
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	...
  	"image_alt" varchar,
  	"show_buttons" boolean DEFAULT true,
  	"color_scheme" "enum_posts_blocks_two_column_layout_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "posts_blocks_feature_grid_bottom_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_posts_blocks_feature_grid_bottom_buttons_variant" DEFAULT 'secondary'
  );
  ...
  CREATE TABLE "posts_blocks_feature_grid" (
  	...
  	"item_type" "enum_posts_blocks_feature_grid_item_type" DEFAULT 'icon',
  	"show_header_section" boolean DEFAULT true,
  	"header_section_tagline" varchar,
  	"header_section_heading" varchar,
  	"header_section_description" jsonb,
  	"show_item_buttons" boolean DEFAULT true,
  	"show_bottom_buttons" boolean DEFAULT false,
  	"color_scheme" "enum_posts_blocks_feature_grid_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_header_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_posts_blocks_header_buttons_variant" DEFAULT 'primary'
  );
  ...
  CREATE TABLE "posts_blocks_header" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_posts_blocks_header_layout" DEFAULT 'split',
  	"image_position" "enum_posts_blocks_header_image_position" DEFAULT 'right',
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	...
  	"overlay_opacity" numeric DEFAULT 0.5,
  	"show_buttons" boolean DEFAULT true,
  	"color_scheme" "enum_posts_blocks_header_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "posts_blocks_gallery" (
  	...
  	"heading" varchar,
  	"description" jsonb,
  	"color_scheme" "enum_posts_blocks_gallery_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_contact_info_methods" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" "enum_posts_blocks_contact_info_methods_icon" DEFAULT 'email',
  	"title" varchar,
  	"description" varchar,
  	"link_text" varchar,
  	"link_href" varchar
  ...
  CREATE TABLE "posts_blocks_contact_info" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"color_scheme" "enum_posts_blocks_contact_info_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_blog_grid_categories" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"category" varchar
  ...
  CREATE TABLE "posts_blocks_blog_grid_posts" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "posts_blocks_blog_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"description" jsonb,
  	"show_categories" boolean DEFAULT false,
  	"color_scheme" "enum_posts_blocks_blog_grid_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  
  CREATE TABLE "posts_blocks_dynamic_blog_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"post_source" "enum_posts_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  	...
  	"description" jsonb,
  	"show_categories" boolean DEFAULT false,
  	"color_scheme" "enum_posts_blocks_dynamic_blog_grid_color_scheme" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__posts_v_blocks_cta_buttons_variant" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__posts_v_blocks_cta_layout" DEFAULT 'split',
  	"show_tagline" boolean DEFAULT false,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	"cta_type" "enum__posts_v_blocks_cta_cta_type" DEFAULT 'form',
  	"form_settings_form_placeholder" varchar DEFAULT 'Voer je e-mail in',
  	"form_settings_form_button_text" varchar DEFAULT 'Inschrijven',
  	"form_settings_terms_text" varchar DEFAULT 'By clicking Sign Up you''re confirming that you agree with our Terms and Conditions.',
  	"form_settings_terms_link" varchar DEFAULT '/terms',
  	...
  	"image_id" integer,
  	"image_alt" varchar,
  	"color_scheme" "enum__posts_v_blocks_cta_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_faq_faqs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"question" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_faq" (
  	...
  	"contact_section_contact_button_text" varchar DEFAULT 'Contact',
  	"contact_section_contact_button_link" varchar DEFAULT '/contact',
  	"color_scheme" "enum__posts_v_blocks_faq_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_team" (
  	...
  	"hiring_section_hiring_button_text" varchar DEFAULT 'Open posities',
  	"hiring_section_hiring_button_link" varchar DEFAULT '/careers',
  	"color_scheme" "enum__posts_v_blocks_team_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_testimonials_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"rating" numeric DEFAULT 5,
  ...
  CREATE TABLE "_posts_v_blocks_testimonials" (
  	...
  	"description" jsonb,
  	"show_stars" boolean DEFAULT true,
  	"color_scheme" "enum__posts_v_blocks_testimonials_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_pricing_table_plans_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"feature" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_pricing_table_plans" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_pricing_table" (
  	...
  	"description" jsonb,
  	"show_billing_toggle" boolean DEFAULT true,
  	"color_scheme" "enum__posts_v_blocks_pricing_table_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_two_column_layout_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__posts_v_blocks_two_column_layout_buttons_variant" DEFAULT 'secondary',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_two_column_layout" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_position" "enum__posts_v_blocks_two_column_layout_image_position" DEFAULT 'right',
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	...
  	"image_alt" varchar,
  	"show_buttons" boolean DEFAULT true,
  	"color_scheme" "enum__posts_v_blocks_two_column_layout_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_feature_grid_bottom_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__posts_v_blocks_feature_grid_bottom_buttons_variant" DEFAULT 'secondary',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_feature_grid" (
  	...
  	"item_type" "enum__posts_v_blocks_feature_grid_item_type" DEFAULT 'icon',
  	"show_header_section" boolean DEFAULT true,
  	"header_section_tagline" varchar,
  	"header_section_heading" varchar,
  	"header_section_description" jsonb,
  	"show_item_buttons" boolean DEFAULT true,
  	"show_bottom_buttons" boolean DEFAULT false,
  	"color_scheme" "enum__posts_v_blocks_feature_grid_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_header_buttons" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__posts_v_blocks_header_buttons_variant" DEFAULT 'primary',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_header" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__posts_v_blocks_header_layout" DEFAULT 'split',
  	"image_position" "enum__posts_v_blocks_header_image_position" DEFAULT 'right',
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar,
  	"heading" varchar,
  	"description" jsonb,
  	...
  	"overlay_opacity" numeric DEFAULT 0.5,
  	"show_buttons" boolean DEFAULT true,
  	"color_scheme" "enum__posts_v_blocks_header_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_posts_v_blocks_gallery" (
  	...
  	"heading" varchar,
  	"description" jsonb,
  	"color_scheme" "enum__posts_v_blocks_gallery_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_contact_info_methods" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" "enum__posts_v_blocks_contact_info_methods_icon" DEFAULT 'email',
  	"title" varchar,
  	"description" varchar,
  	"link_text" varchar,
  	"link_href" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_contact_info" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"color_scheme" "enum__posts_v_blocks_contact_info_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_blog_grid_categories" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"category" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_blog_grid_posts" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_posts_v_blocks_blog_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"description" jsonb,
  	"show_categories" boolean DEFAULT false,
  	"color_scheme" "enum__posts_v_blocks_blog_grid_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_posts_v_blocks_dynamic_blog_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"post_source" "enum__posts_v_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  	...
  	"description" jsonb,
  	"show_categories" boolean DEFAULT false,
  	"color_scheme" "enum__posts_v_blocks_dynamic_blog_grid_color_scheme" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "courses_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_courses_blocks_cta_buttons_variant" DEFAULT 'default'
  );
  ...
  CREATE TABLE "courses_blocks_archive" (
  	...
  	"relation_to" "enum_courses_blocks_archive_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "courses_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"post_source" "enum_courses_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  ...
  CREATE TABLE "_courses_v_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum__courses_v_blocks_cta_buttons_variant" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_courses_v_blocks_archive" (
  	...
  	"relation_to" "enum__courses_v_blocks_archive_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_courses_v_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"post_source" "enum__courses_v_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest',
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  ...
  CREATE TABLE "global_cta" (
  	...
  	"image_id" integer,
  	"image_alt" varchar,
  	"color_scheme" "enum_global_cta_color_scheme" DEFAULT 'primary' NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "blog_overview_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_blog_overview_blocks_cta_buttons_variant" DEFAULT 'default'
  );
  ...
  CREATE TABLE "blog_overview_blocks_archive" (
  	...
  	"relation_to" "enum_blog_overview_blocks_archive_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "blog_overview_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"post_source" "enum_blog_overview_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest' NOT NULL,
  	"category_filter_id" integer,
  ...
  CREATE TABLE "course_overview_blocks_cta_buttons" (
  	...
  	"text" varchar,
  	"link" varchar,
  	"variant" "enum_course_overview_blocks_cta_buttons_variant" DEFAULT 'default'
  );
  ...
  CREATE TABLE "course_overview_blocks_archive" (
  	...
  	"relation_to" "enum_course_overview_blocks_archive_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "course_overview_blocks_dynamic_blog_grid" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"post_source" "enum_course_overview_blocks_dynamic_blog_grid_post_source" DEFAULT 'latest' NOT NULL,
  	"category_filter_id" integer,
  	"limit" numeric DEFAULT 9 NOT NULL,
  	"show_tagline" boolean DEFAULT true,
  	"tagline" varchar DEFAULT 'Blog',
  ...
  ALTER TABLE "posts_blocks_faq_faqs" ADD CONSTRAINT "posts_blocks_faq_faqs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_faq"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_team_members" ADD CONSTRAINT "posts_blocks_team_members_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_testimonials_testimonials" ADD CONSTRAINT "posts_blocks_testimonials_testimonials_author_avatar_id_media_id_fk" FOREIGN KEY ("author_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_testimonials_testimonials" ADD CONSTRAINT "posts_blocks_testimonials_testimonials_company_logo_id_media_id_fk" FOREIGN KEY ("company_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_testimonials_testimonials" ADD CONSTRAINT "posts_blocks_testimonials_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_testimonials"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_pricing_table_plans_features" ADD CONSTRAINT "posts_blocks_pricing_table_plans_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_pricing_table_plans"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_pricing_table_plans" ADD CONSTRAINT "posts_blocks_pricing_table_plans_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_pricing_table"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_two_column_layout_buttons" ADD CONSTRAINT "posts_blocks_two_column_layout_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_two_column_layout"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_two_column_layout" ADD CONSTRAINT "posts_blocks_two_column_layout_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_two_column_layout" ADD CONSTRAINT "posts_blocks_two_column_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_feature_grid_features" ADD CONSTRAINT "posts_blocks_feature_grid_features_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_feature_grid_features" ADD CONSTRAINT "posts_blocks_feature_grid_features_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_feature_grid_bottom_buttons" ADD CONSTRAINT "posts_blocks_feature_grid_bottom_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_feature_grid"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_header_buttons" ADD CONSTRAINT "posts_blocks_header_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_header" ADD CONSTRAINT "posts_blocks_header_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "posts_blocks_contact_info_methods" ADD CONSTRAINT "posts_blocks_contact_info_methods_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_contact_info"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_contact_info" ADD CONSTRAINT "posts_blocks_contact_info_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_blog_grid_categories" ADD CONSTRAINT "posts_blocks_blog_grid_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_blog_grid"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_blog_grid_posts" ADD CONSTRAINT "posts_blocks_blog_grid_posts_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_blog_grid_posts" ADD CONSTRAINT "posts_blocks_blog_grid_posts_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_blog_grid"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_blog_grid" ADD CONSTRAINT "posts_blocks_blog_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "posts_blocks_dynamic_blog_grid" ADD CONSTRAINT "posts_blocks_dynamic_blog_grid_category_filter_id_categories_id_fk" FOREIGN KEY ("category_filter_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "posts_blocks_dynamic_blog_grid" ADD CONSTRAINT "posts_blocks_dynamic_blog_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_faq_faqs" ADD CONSTRAINT "_posts_v_blocks_faq_faqs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_faq"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_team_members" ADD CONSTRAINT "_posts_v_blocks_team_members_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_testimonials_testimonials" ADD CONSTRAINT "_posts_v_blocks_testimonials_testimonials_author_avatar_id_media_id_fk" FOREIGN KEY ("author_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_testimonials_testimonials" ADD CONSTRAINT "_posts_v_blocks_testimonials_testimonials_company_logo_id_media_id_fk" FOREIGN KEY ("company_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_testimonials_testimonials" ADD CONSTRAINT "_posts_v_blocks_testimonials_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_testimonials"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_pricing_table_plans_features" ADD CONSTRAINT "_posts_v_blocks_pricing_table_plans_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_pricing_table_plans"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_pricing_table_plans" ADD CONSTRAINT "_posts_v_blocks_pricing_table_plans_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_pricing_table"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_two_column_layout_buttons" ADD CONSTRAINT "_posts_v_blocks_two_column_layout_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_two_column_layout"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_two_column_layout" ADD CONSTRAINT "_posts_v_blocks_two_column_layout_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_two_column_layout" ADD CONSTRAINT "_posts_v_blocks_two_column_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_feature_grid_features" ADD CONSTRAINT "_posts_v_blocks_feature_grid_features_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_feature_grid_features" ADD CONSTRAINT "_posts_v_blocks_feature_grid_features_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_feature_grid_bottom_buttons" ADD CONSTRAINT "_posts_v_blocks_feature_grid_bottom_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_feature_grid"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_header_buttons" ADD CONSTRAINT "_posts_v_blocks_header_buttons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_header" ADD CONSTRAINT "_posts_v_blocks_header_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v_blocks_contact_info_methods" ADD CONSTRAINT "_posts_v_blocks_contact_info_methods_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_contact_info"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_contact_info" ADD CONSTRAINT "_posts_v_blocks_contact_info_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_blog_grid_categories" ADD CONSTRAINT "_posts_v_blocks_blog_grid_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_blog_grid"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_blog_grid_posts" ADD CONSTRAINT "_posts_v_blocks_blog_grid_posts_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_blog_grid_posts" ADD CONSTRAINT "_posts_v_blocks_blog_grid_posts_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_blog_grid"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_blog_grid" ADD CONSTRAINT "_posts_v_blocks_blog_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_dynamic_blog_grid" ADD CONSTRAINT "_posts_v_blocks_dynamic_blog_grid_category_filter_id_categories_id_fk" FOREIGN KEY ("category_filter_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_posts_v_blocks_dynamic_blog_grid" ADD CONSTRAINT "_posts_v_blocks_dynamic_blog_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "courses_rels" ADD CONSTRAINT "courses_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_courses_v_rels" ADD CONSTRAINT "_courses_v_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "blog_overview_rels" ADD CONSTRAINT "blog_overview_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "course_overview_rels" ADD CONSTRAINT "course_overview_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "posts_blocks_faq_faqs_order_idx" ON "posts_blocks_faq_faqs" USING btree ("_order");
  CREATE INDEX "posts_blocks_faq_faqs_parent_id_idx" ON "posts_blocks_faq_faqs" USING btree ("_parent_id");
  ...
  CREATE INDEX "posts_blocks_team_members_avatar_idx" ON "posts_blocks_team_members" USING btree ("avatar_id");
  ...
  CREATE INDEX "posts_blocks_testimonials_testimonials_order_idx" ON "posts_blocks_testimonials_testimonials" USING btree ("_order");
  CREATE INDEX "posts_blocks_testimonials_testimonials_parent_id_idx" ON "posts_blocks_testimonials_testimonials" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_testimonials_testimonials_author_author_ava_idx" ON "posts_blocks_testimonials_testimonials" USING btree ("author_avatar_id");
  CREATE INDEX "posts_blocks_testimonials_testimonials_company_logo_idx" ON "posts_blocks_testimonials_testimonials" USING btree ("company_logo_id");
  ...
  CREATE INDEX "posts_blocks_pricing_table_plans_features_order_idx" ON "posts_blocks_pricing_table_plans_features" USING btree ("_order");
  CREATE INDEX "posts_blocks_pricing_table_plans_features_parent_id_idx" ON "posts_blocks_pricing_table_plans_features" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_pricing_table_plans_order_idx" ON "posts_blocks_pricing_table_plans" USING btree ("_order");
  CREATE INDEX "posts_blocks_pricing_table_plans_parent_id_idx" ON "posts_blocks_pricing_table_plans" USING btree ("_parent_id");
  ...
  CREATE INDEX "posts_blocks_two_column_layout_buttons_order_idx" ON "posts_blocks_two_column_layout_buttons" USING btree ("_order");
  CREATE INDEX "posts_blocks_two_column_layout_buttons_parent_id_idx" ON "posts_blocks_two_column_layout_buttons" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_two_column_layout_order_idx" ON "posts_blocks_two_column_layout" USING btree ("_order");
  CREATE INDEX "posts_blocks_two_column_layout_parent_id_idx" ON "posts_blocks_two_column_layout" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_two_column_layout_path_idx" ON "posts_blocks_two_column_layout" USING btree ("_path");
  CREATE INDEX "posts_blocks_two_column_layout_image_idx" ON "posts_blocks_two_column_layout" USING btree ("image_id");
  ...
  CREATE INDEX "posts_blocks_feature_grid_features_icon_idx" ON "posts_blocks_feature_grid_features" USING btree ("icon_id");
  CREATE INDEX "posts_blocks_feature_grid_features_image_idx" ON "posts_blocks_feature_grid_features" USING btree ("image_id");
  CREATE INDEX "posts_blocks_feature_grid_bottom_buttons_order_idx" ON "posts_blocks_feature_grid_bottom_buttons" USING btree ("_order");
  CREATE INDEX "posts_blocks_feature_grid_bottom_buttons_parent_id_idx" ON "posts_blocks_feature_grid_bottom_buttons" USING btree ("_parent_id");
  ...
  CREATE INDEX "posts_blocks_header_buttons_order_idx" ON "posts_blocks_header_buttons" USING btree ("_order");
  CREATE INDEX "posts_blocks_header_buttons_parent_id_idx" ON "posts_blocks_header_buttons" USING btree ("_parent_id");
  ...
  CREATE INDEX "posts_blocks_header_image_idx" ON "posts_blocks_header" USING btree ("image_id");
  ...
  CREATE INDEX "posts_blocks_contact_info_methods_order_idx" ON "posts_blocks_contact_info_methods" USING btree ("_order");
  CREATE INDEX "posts_blocks_contact_info_methods_parent_id_idx" ON "posts_blocks_contact_info_methods" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_contact_info_order_idx" ON "posts_blocks_contact_info" USING btree ("_order");
  CREATE INDEX "posts_blocks_contact_info_parent_id_idx" ON "posts_blocks_contact_info" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_contact_info_path_idx" ON "posts_blocks_contact_info" USING btree ("_path");
  CREATE INDEX "posts_blocks_blog_grid_categories_order_idx" ON "posts_blocks_blog_grid_categories" USING btree ("_order");
  CREATE INDEX "posts_blocks_blog_grid_categories_parent_id_idx" ON "posts_blocks_blog_grid_categories" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_blog_grid_posts_order_idx" ON "posts_blocks_blog_grid_posts" USING btree ("_order");
  CREATE INDEX "posts_blocks_blog_grid_posts_parent_id_idx" ON "posts_blocks_blog_grid_posts" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_blog_grid_posts_image_idx" ON "posts_blocks_blog_grid_posts" USING btree ("image_id");
  CREATE INDEX "posts_blocks_blog_grid_order_idx" ON "posts_blocks_blog_grid" USING btree ("_order");
  CREATE INDEX "posts_blocks_blog_grid_parent_id_idx" ON "posts_blocks_blog_grid" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_blog_grid_path_idx" ON "posts_blocks_blog_grid" USING btree ("_path");
  CREATE INDEX "posts_blocks_dynamic_blog_grid_order_idx" ON "posts_blocks_dynamic_blog_grid" USING btree ("_order");
  CREATE INDEX "posts_blocks_dynamic_blog_grid_parent_id_idx" ON "posts_blocks_dynamic_blog_grid" USING btree ("_parent_id");
  CREATE INDEX "posts_blocks_dynamic_blog_grid_path_idx" ON "posts_blocks_dynamic_blog_grid" USING btree ("_path");
  CREATE INDEX "posts_blocks_dynamic_blog_grid_category_filter_idx" ON "posts_blocks_dynamic_blog_grid" USING btree ("category_filter_id");
  ...
  CREATE INDEX "_posts_v_blocks_faq_faqs_order_idx" ON "_posts_v_blocks_faq_faqs" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_faq_faqs_parent_id_idx" ON "_posts_v_blocks_faq_faqs" USING btree ("_parent_id");
  ...
  CREATE INDEX "_posts_v_blocks_team_members_avatar_idx" ON "_posts_v_blocks_team_members" USING btree ("avatar_id");
  ...
  CREATE INDEX "_posts_v_blocks_testimonials_testimonials_order_idx" ON "_posts_v_blocks_testimonials_testimonials" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_testimonials_testimonials_parent_id_idx" ON "_posts_v_blocks_testimonials_testimonials" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_testimonials_testimonials_author_author__idx" ON "_posts_v_blocks_testimonials_testimonials" USING btree ("author_avatar_id");
  CREATE INDEX "_posts_v_blocks_testimonials_testimonials_company_logo_idx" ON "_posts_v_blocks_testimonials_testimonials" USING btree ("company_logo_id");
  ...
  CREATE INDEX "_posts_v_blocks_pricing_table_plans_features_order_idx" ON "_posts_v_blocks_pricing_table_plans_features" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_pricing_table_plans_features_parent_id_idx" ON "_posts_v_blocks_pricing_table_plans_features" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_pricing_table_plans_order_idx" ON "_posts_v_blocks_pricing_table_plans" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_pricing_table_plans_parent_id_idx" ON "_posts_v_blocks_pricing_table_plans" USING btree ("_parent_id");
  ...
  CREATE INDEX "_posts_v_blocks_two_column_layout_buttons_order_idx" ON "_posts_v_blocks_two_column_layout_buttons" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_two_column_layout_buttons_parent_id_idx" ON "_posts_v_blocks_two_column_layout_buttons" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_two_column_layout_order_idx" ON "_posts_v_blocks_two_column_layout" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_two_column_layout_parent_id_idx" ON "_posts_v_blocks_two_column_layout" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_two_column_layout_path_idx" ON "_posts_v_blocks_two_column_layout" USING btree ("_path");
  CREATE INDEX "_posts_v_blocks_two_column_layout_image_idx" ON "_posts_v_blocks_two_column_layout" USING btree ("image_id");
  ...
  CREATE INDEX "_posts_v_blocks_feature_grid_features_icon_idx" ON "_posts_v_blocks_feature_grid_features" USING btree ("icon_id");
  CREATE INDEX "_posts_v_blocks_feature_grid_features_image_idx" ON "_posts_v_blocks_feature_grid_features" USING btree ("image_id");
  CREATE INDEX "_posts_v_blocks_feature_grid_bottom_buttons_order_idx" ON "_posts_v_blocks_feature_grid_bottom_buttons" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_feature_grid_bottom_buttons_parent_id_idx" ON "_posts_v_blocks_feature_grid_bottom_buttons" USING btree ("_parent_id");
  ...
  CREATE INDEX "_posts_v_blocks_header_buttons_order_idx" ON "_posts_v_blocks_header_buttons" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_header_buttons_parent_id_idx" ON "_posts_v_blocks_header_buttons" USING btree ("_parent_id");
  ...
  CREATE INDEX "_posts_v_blocks_header_image_idx" ON "_posts_v_blocks_header" USING btree ("image_id");
  ...
  CREATE INDEX "_posts_v_blocks_contact_info_methods_order_idx" ON "_posts_v_blocks_contact_info_methods" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_contact_info_methods_parent_id_idx" ON "_posts_v_blocks_contact_info_methods" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_contact_info_order_idx" ON "_posts_v_blocks_contact_info" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_contact_info_parent_id_idx" ON "_posts_v_blocks_contact_info" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_contact_info_path_idx" ON "_posts_v_blocks_contact_info" USING btree ("_path");
  CREATE INDEX "_posts_v_blocks_blog_grid_categories_order_idx" ON "_posts_v_blocks_blog_grid_categories" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_blog_grid_categories_parent_id_idx" ON "_posts_v_blocks_blog_grid_categories" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_blog_grid_posts_order_idx" ON "_posts_v_blocks_blog_grid_posts" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_blog_grid_posts_parent_id_idx" ON "_posts_v_blocks_blog_grid_posts" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_blog_grid_posts_image_idx" ON "_posts_v_blocks_blog_grid_posts" USING btree ("image_id");
  CREATE INDEX "_posts_v_blocks_blog_grid_order_idx" ON "_posts_v_blocks_blog_grid" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_blog_grid_parent_id_idx" ON "_posts_v_blocks_blog_grid" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_blog_grid_path_idx" ON "_posts_v_blocks_blog_grid" USING btree ("_path");
  CREATE INDEX "_posts_v_blocks_dynamic_blog_grid_order_idx" ON "_posts_v_blocks_dynamic_blog_grid" USING btree ("_order");
  CREATE INDEX "_posts_v_blocks_dynamic_blog_grid_parent_id_idx" ON "_posts_v_blocks_dynamic_blog_grid" USING btree ("_parent_id");
  CREATE INDEX "_posts_v_blocks_dynamic_blog_grid_path_idx" ON "_posts_v_blocks_dynamic_blog_grid" USING btree ("_path");
  CREATE INDEX "_posts_v_blocks_dynamic_blog_grid_category_filter_idx" ON "_posts_v_blocks_dynamic_blog_grid" USING btree ("category_filter_id");
  ...
  CREATE INDEX "courses_rels_posts_id_idx" ON "courses_rels" USING btree ("posts_id");
  ...
  CREATE INDEX "_courses_v_rels_posts_id_idx" ON "_courses_v_rels" USING btree ("posts_id");
  ...
  CREATE INDEX "blog_overview_rels_posts_id_idx" ON "blog_overview_rels" USING btree ("posts_id");
  ...
  CREATE INDEX "course_overview_rels_posts_id_idx" ON "course_overview_rels" USING btree ("posts_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "posts_blocks_faq_faqs" CASCADE;
  ...
  DROP TABLE "posts_blocks_testimonials_testimonials" CASCADE;
  DROP TABLE "posts_blocks_testimonials" CASCADE;
  DROP TABLE "posts_blocks_pricing_table_plans_features" CASCADE;
  DROP TABLE "posts_blocks_pricing_table_plans" CASCADE;
  DROP TABLE "posts_blocks_pricing_table" CASCADE;
  DROP TABLE "posts_blocks_two_column_layout_buttons" CASCADE;
  DROP TABLE "posts_blocks_two_column_layout" CASCADE;
  DROP TABLE "posts_blocks_feature_grid_features" CASCADE;
  DROP TABLE "posts_blocks_feature_grid_bottom_buttons" CASCADE;
  DROP TABLE "posts_blocks_feature_grid" CASCADE;
  DROP TABLE "posts_blocks_header_buttons" CASCADE;
  ...
  DROP TABLE "posts_blocks_contact_info_methods" CASCADE;
  DROP TABLE "posts_blocks_contact_info" CASCADE;
  DROP TABLE "posts_blocks_blog_grid_categories" CASCADE;
  DROP TABLE "posts_blocks_blog_grid_posts" CASCADE;
  DROP TABLE "posts_blocks_blog_grid" CASCADE;
  DROP TABLE "posts_blocks_dynamic_blog_grid" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_faq_faqs" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_testimonials_testimonials" CASCADE;
  DROP TABLE "_posts_v_blocks_testimonials" CASCADE;
  DROP TABLE "_posts_v_blocks_pricing_table_plans_features" CASCADE;
  DROP TABLE "_posts_v_blocks_pricing_table_plans" CASCADE;
  DROP TABLE "_posts_v_blocks_pricing_table" CASCADE;
  DROP TABLE "_posts_v_blocks_two_column_layout_buttons" CASCADE;
  DROP TABLE "_posts_v_blocks_two_column_layout" CASCADE;
  DROP TABLE "_posts_v_blocks_feature_grid_features" CASCADE;
  DROP TABLE "_posts_v_blocks_feature_grid_bottom_buttons" CASCADE;
  DROP TABLE "_posts_v_blocks_feature_grid" CASCADE;
  DROP TABLE "_posts_v_blocks_header_buttons" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_contact_info_methods" CASCADE;
  DROP TABLE "_posts_v_blocks_contact_info" CASCADE;
  DROP TABLE "_posts_v_blocks_blog_grid_categories" CASCADE;
  DROP TABLE "_posts_v_blocks_blog_grid_posts" CASCADE;
  DROP TABLE "_posts_v_blocks_blog_grid" CASCADE;
  DROP TABLE "_posts_v_blocks_dynamic_blog_grid" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_dynamic_blog_grid_post_source";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_dynamic_blog_grid_post_source";
  DROP TYPE "public"."enum__pages_v_blocks_dynamic_blog_grid_color_scheme";
  DROP TYPE "public"."enum__pages_v_version_hero_type";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_posts_blocks_cta_buttons_variant";
  DROP TYPE "public"."enum_posts_blocks_cta_layout";
  DROP TYPE "public"."enum_posts_blocks_cta_cta_type";
  DROP TYPE "public"."enum_posts_blocks_cta_color_scheme";
  ...
  DROP TYPE "public"."enum_posts_blocks_faq_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_team_members_social_links_platform";
  DROP TYPE "public"."enum_posts_blocks_team_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_testimonials_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_pricing_table_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_two_column_layout_buttons_variant";
  DROP TYPE "public"."enum_posts_blocks_two_column_layout_image_position";
  DROP TYPE "public"."enum_posts_blocks_two_column_layout_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_feature_grid_bottom_buttons_variant";
  DROP TYPE "public"."enum_posts_blocks_feature_grid_columns";
  DROP TYPE "public"."enum_posts_blocks_feature_grid_item_type";
  DROP TYPE "public"."enum_posts_blocks_feature_grid_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_header_buttons_variant";
  DROP TYPE "public"."enum_posts_blocks_header_layout";
  DROP TYPE "public"."enum_posts_blocks_header_image_position";
  DROP TYPE "public"."enum_posts_blocks_header_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_gallery_columns";
  DROP TYPE "public"."enum_posts_blocks_gallery_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_contact_info_methods_icon";
  DROP TYPE "public"."enum_posts_blocks_contact_info_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_blog_grid_color_scheme";
  DROP TYPE "public"."enum_posts_blocks_dynamic_blog_grid_post_source";
  DROP TYPE "public"."enum_posts_blocks_dynamic_blog_grid_color_scheme";
  DROP TYPE "public"."enum_posts_status";
  DROP TYPE "public"."enum__posts_v_blocks_cta_buttons_variant";
  DROP TYPE "public"."enum__posts_v_blocks_cta_layout";
  DROP TYPE "public"."enum__posts_v_blocks_cta_cta_type";
  DROP TYPE "public"."enum__posts_v_blocks_cta_color_scheme";
  ...
  DROP TYPE "public"."enum__posts_v_blocks_faq_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_team_members_social_links_platform";
  DROP TYPE "public"."enum__posts_v_blocks_team_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_testimonials_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_pricing_table_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_two_column_layout_buttons_variant";
  DROP TYPE "public"."enum__posts_v_blocks_two_column_layout_image_position";
  DROP TYPE "public"."enum__posts_v_blocks_two_column_layout_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_feature_grid_bottom_buttons_variant";
  DROP TYPE "public"."enum__posts_v_blocks_feature_grid_columns";
  DROP TYPE "public"."enum__posts_v_blocks_feature_grid_item_type";
  DROP TYPE "public"."enum__posts_v_blocks_feature_grid_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_header_buttons_variant";
  DROP TYPE "public"."enum__posts_v_blocks_header_layout";
  DROP TYPE "public"."enum__posts_v_blocks_header_image_position";
  DROP TYPE "public"."enum__posts_v_blocks_header_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_gallery_columns";
  DROP TYPE "public"."enum__posts_v_blocks_gallery_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_contact_info_methods_icon";
  DROP TYPE "public"."enum__posts_v_blocks_contact_info_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_blog_grid_color_scheme";
  DROP TYPE "public"."enum__posts_v_blocks_dynamic_blog_grid_post_source";
  DROP TYPE "public"."enum__posts_v_blocks_dynamic_blog_grid_color_scheme";
  ...
  DROP TYPE "public"."enum_courses_blocks_dynamic_blog_grid_post_source";
  ...
  DROP TYPE "public"."enum__courses_v_blocks_dynamic_blog_grid_post_source";
  ...
  DROP TYPE "public"."enum_blog_overview_blocks_dynamic_blog_grid_post_source";
  ...
  DROP TYPE "public"."enum_course_overview_blocks_dynamic_blog_grid_post_source";
